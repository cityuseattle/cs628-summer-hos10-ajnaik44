  ...
  new FacebookStrategy(
    {
      ...
      clientSecret: '',
      // Your callback URL
      callbackURL: 'https://jubilant-cod-69wxpvp64vp245wr-5050.app.github.dev/facebook/callback', 
...
app.get('/facebook/callback', passport.authenticate('facebook', {
  ...
  successRedirect: 'https://jubilant-cod-69wxpvp64vp245wr-3000.app.github.dev/home', 
  // Redirect to login page on authentication failure.
  failureRedirect: 'https://jubilant-cod-69wxpvp64vp245wr-3000.app.github.dev/', 
}));
